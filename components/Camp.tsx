        ...
        bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
            ...
            lg:px-20 lg:py-10">
                ...
                <div className="flexCenter gap-6">
                    ...
                    <p className="bold-16 md:text-[20px]! md:font-[700]! text-white">
                        {peopleJoined}
                    </p>
                </div>
...
const Camp = () => {
    return (
        <section className="xl:mx-auto xl:max-w-[1440px]
        relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
            ...
            <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
                ...
                xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
                    <h2 className="regular-24 md:text-[32px]! md:font-[400]! 2xl:text-[64px]!
                    2xl:font-[400]! 2xl:leading-[120%]! capitalize text-white">
                        <strong>Feeling Lost</strong> And Not Knowing The Way?
                    </h2>

                    <p className="regular-14 mt-5 text-white xl:text-[16px] xl:font-[400]">
